 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Product-Placer-Simple-Title
 * Plugin URI:        https://wp2mag.blogspot.com/2021/07/product-placer.html
 ...
 */
function deactivate_product_placer_simple() {
...
register_activation_hook( __FILE__, 'activate_product_placer_simple' );
register_deactivation_hook( __FILE__, 'deactivate_product_placer_simple' );
 ...
 * @since    1.0.0
 */
function run_product_placer_simple() {

	$plugin = new Product_Placer_Simple();
	$plugin->run();

}
run_product_placer_simple();
