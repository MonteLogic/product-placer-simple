...
function pps_sidebar_profile() {
    ...
    <button type="button" class="button button-secondary upload_image_button_pps" value="Upload Product Picture" id="upload-button">
    ...
    if(!empty($imgURLValueCA) && ($imgURLValueOp != "null") ){
        ...
        ?>
    <button type="button" class="button button-secondary upload_image_button_pps" value="Replace Product Picture" id="upload-button">
